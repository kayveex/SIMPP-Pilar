...
class AnggaranRealisasiExport implements FromCollection, WithHeadings, WithMapping
{
    protected $project;
    ...
    public function __construct($projectId)
    {
        ...
        // Collect all budget items from Realisasi only
        $this->budgetItems = collect();
        
        // Add Realisasi Anggaran items
        $anggaranRealisasi = AnggaranRealisasi::where('project_id', $projectId)
            ->with('items')
