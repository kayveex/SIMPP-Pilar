...
<div class="p-6 bg-gray-50 min-h-screen">
    ...
    <div class="card bg-white shadow-lg">
        <div class="card-body p-8">
            ...
            <!-- File Upload and Vendor Section -->
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                <!-- File Upload -->
                <div>
                    ...
                    <div id="currentFile" class="mt-2 text-sm text-gray-600">
                        <i class="ph ph-paperclip mr-1"></i>
                        <span>Foto_Bukti.jpg</span>
                    </div>
                </div>
...
function clearFile() {
    ...
    currentFileDiv.innerHTML = `
        <i class="ph ph-paperclip mr-1"></i>
        <span>Tidak ada file dipilih</span>
    `;
}
