...
{{-- Page Title --}}
@section('page_title')
    Daftar Proyek - SIMPP Pillar Presisi
@endsection
...
@section('page-content')
    <section class="flex flex-col p-6">
        ...
        <div class="flex flex-row items-center justify-between mb-4">
            <h1 class="text-2xl font-bold text-gray-800">Daftar Proyek Terarsip</h1>
        </div>
        ...
        <div class="flex flex-row w-full gap-4 bg-white shadow-sm rounded-lg p-4 mb-6 border-gray-200">
            ...
            {{-- Filter Controls --}}
            <form class="flex flex-row w-2/3 items-center justify-end gap-2" action="" method="GET">
                ...
                {{-- Make reset button --}}
                <a href="{{ route('arsip-proyek.index') }}" class="px-4 py-2 bg-white text-red-600 flex flex-row items-center cursor-pointer rounded-lg hover:bg-red-600 hover:text-white transition duration-200">
                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-50 transition duration-200">
                                ...
                                <td class="flex flex-row justify-center items-center gap-2">
                                    <div class="flex flex-row gap-2 text-lg">
                                        <a href="{{ route('arsip-proyek.show', $project->project_id) }}" class="py-2 text-blue-600 hover:text-blue-800 transition duration-200" title="Lihat Detail Proyek">
