        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex items-center space-x-2">
                <button class="p-2 rounded-lg hover:bg-gray-100">
                    <i class="ph ph-check-square text-gray-600 w-5 h-5"></i>
                </button>
                <button class="p-2 rounded-lg hover:bg-gray-100">
                    <i class="ph ph-user text-gray-600 w-5 h-5"></i>
                </button>
            </div>
        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="flex space-x-2">
                                    ...
                                    <button type="button" onclick="openDropdownModal()"
                            ...
                            <div>
                                ...
                                <div class="flex">
                                    ...
                                    <button type="button" onclick="openUploadModal()"
                                        class="px-4 py-2 bg-gray-500 text-white rounded-r-md hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500">
                                        Upload
                                    </button>
                                </div>
                            </div>
            ...
            <div class="bg-white rounded-lg shadow-xl max-w-md w-full">
                ...
                <div class="p-6">
                    <div class="text-center">
                        <div class="mb-4">
                            <i class="ph ph-cloud-arrow-up text-gray-400 w-12 h-12 mx-auto"></i>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <div
                                    ...
                                    <button type="button" onclick="document.getElementById('fileInput').click()"
                                        class="w-full">
                                        <i class="ph ph-plus-circle mx-auto w-8 h-8 text-gray-400 mb-2"></i>
                            ...
                            <div>
                                ...
                                <input type="text" placeholder="Masukkan nama file"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Keterangan</label>
                                <textarea rows="3" placeholder="Masukkan keterangan file"
